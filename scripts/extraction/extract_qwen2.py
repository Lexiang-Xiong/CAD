"""
Feature extraction script for Qwen2-VL model.
...
def main():
    parser = argparse.ArgumentParser(description='Extract cognitive metrics from Qwen2-VL')
    ...
    parser.add_argument('--output_dir', type=str, default='results/qwen2',
