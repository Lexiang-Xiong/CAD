"""
Feature extraction script for DeepSeek-VL2 model.
...
def main():
    parser = argparse.ArgumentParser(description='Extract cognitive metrics from DeepSeek-VL2')
    parser.add_argument('--model_id', type=str, default='deepseek-ai/deepseek-vl2-tiny',
    ...
    # Import DeepSeek-VL2 here
    from deepseek_vl2 import DeepSeekVLV2ForConditionalGeneration, DeepSeekVLV2Processor

    # Load model and processor
    print(f"Loading model: {args.model_id}")
    processor = DeepSeekVLV2Processor.from_pretrained(args.model_id)
    model = DeepSeekVLV2ForConditionalGeneration.from_pretrained(
        args.model_id,
        device_map='auto',
